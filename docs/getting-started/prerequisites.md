...
**Required for:** Generating .desc descriptor files
**Minimum Version:** 3.0+
**Recommended:** 3.25.0+
...
- [x] protoc is installed for generating descriptors
- [x] Network access to gRPC server is available
- [x] gRPC server has a server streaming method
- [x] Protocol Buffer descriptor file is generated
...
1. [Installation](https://github.com/conduktor/kafka-connect-grpc/blob/main/README.md#installation) - Install the connector
2. [Configuration](configuration.md) - Configure all connector parameters
3. [Quick Start](https://github.com/conduktor/kafka-connect-grpc/blob/main/README.md#usage-examples) - Deploy your first connector
