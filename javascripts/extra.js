// Custom JavaScript for Kafka Connect gRPC Documentation
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Console Easter egg
  console.log('%c🚀 Kafka Connect gRPC Connector', 'color: #ef4444; font-size: 20px; font-weight: bold;');
  console.log('%cBuilt with MkDocs Material', 'color: #3b82f6; font-size: 14px;');
  console.log('%cContribute: https://github.com/conduktor/kafka-connect-grpc', 'color: #10b981; font-size: 12px;');
});
