...
public class TestWaiter {
     ...
     *
     * @param server    the mock gRPC server
     * @param timeoutMs maximum time to wait
     */
    public static void waitForConnection(MockGrpcServer server, long timeoutMs) {
        waitUntil(server::hasActiveConnection, timeoutMs, "gRPC connection should be established");
    }
